      ...
      <div className={`relative ${isCompact ? "max-w-[400px]" : "max-w-4xl"} mx-auto flex items-center justify-center`}>
        ...
        <div className="relative flex-shrink-0">
                ...
                {[0, 90, 180, 270].map((angle, i) => (
                  <motion.div
                    ...
                    style={{
                      top: "50%",
                      left: "50%",
                      transform: `rotate(${angle}deg) translateY(-340px) translateX(-50%)`,
                    }}
          ...
          {showDecorations && (
            <div className="absolute inset-0 flex items-center justify-center pointer-events-none">
              <motion.div
                className="absolute w-[620px] h-[620px] rounded-full border border-gray-200/50"
                initial={{ scale: 0, opacity: 0 }}
                animate={isInView ? { scale: 1, opacity: 1 } : {}}
                transition={{ duration: 1, delay: 0.2 }}
              />
              <motion.div
                className="absolute w-[680px] h-[680px] rounded-full border border-gray-100/30"
                initial={{ scale: 0, opacity: 0 }}
                animate={isInView ? { scale: 1, opacity: 1 } : {}}
                transition={{ duration: 1.2, delay: 0.3 }}
              />
              <motion.div
                className="absolute w-[720px] h-[720px] rounded-full border border-dashed border-gray-100/20"
                animate={{ rotate: -360 }}
