    ...
    testimonials: [
      {
        ...
        role: 'CIO',
        company: 'NRGi',
        services: ['Team Performance', 'Executive Coaching'],
      },
      {
        ...
        services: ['Executive Coaching', 'Leadership Development'],
      },
      {
        ...
        company: 'Arla',
        services: ['Leadership Development', 'Keynotes'],
      },
      {
      ...
      {
        quote: "In my interactions with Stinne, I have always found her to be sharp and analytical. She is solution-oriented and idea-rich. She forms clear opinions and has communication skills that allow her to explain herself in a crisp and concise way. Stinne is not afraid of asking the difficult questions and has very good empathy to know where to push and where to back off. It has been a pleasure working with her.",
